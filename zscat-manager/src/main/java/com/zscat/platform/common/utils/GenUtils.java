...
import com.zscat.platform.common.domain.ColumnDO;
import com.zscat.platform.common.domain.TableDO;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		map.put("datetime", DateUtils.formatDate(new Date(), DateUtils.DATE_PATTERN));
