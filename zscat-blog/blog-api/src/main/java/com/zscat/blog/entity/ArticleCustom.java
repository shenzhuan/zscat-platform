...
public class ArticleCustom implements Serializable {
    ...
    private List<com.zscat.blog.entity.ArticleTag> tagList;   //标签列表
    ...
    public List<com.zscat.blog.entity.ArticleTag> getTagList() {
        return tagList;
    }

    public void setTagList(List<com.zscat.blog.entity.ArticleTag> tagList) {
